...
OcrInitLogger( OCR_HANDLE handle, bool isConsole, bool isPartImg, bool isResultImg );

_QM_OCR_API OCR_BOOL
OcrDetect( OCR_HANDLE handle, const char *imgPath, const char *imgName, OCR_PARAM *pParam );

_QM_OCR_API OCR_BOOL
OcrDetectPath( OCR_HANDLE handle, const char *imgPath, const char *imgName, OCR_PARAM *pParam, OCR_RESULT *ocrResult );
